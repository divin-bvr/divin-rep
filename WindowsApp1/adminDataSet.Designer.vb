...
Partial Public Class adminDataSet
    ...
    Partial Public Class adminDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddadminRow(ByVal user As String, ByVal pwd As String) As adminRow
            Dim rowadminRow As adminRow = CType(Me.NewRow,adminRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, user, pwd}
    ...
    Partial Public Class adminRow
        ...
        Public Function IspwdNull() As Boolean
            Return Me.IsNull(Me.tableadmin.pwdColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetpwdNull()
            Me(Me.tableadmin.pwdColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace adminDataSetTableAdapters
    ...
    Partial Public Class adminTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `admin` (`user`, `pwd`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `admin` SET `user` = ?, `pwd` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `user`"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApp1.My.MySettings.Default.adminConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, [user], pwd FROM admin"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_user As String, ByVal Original_pwd As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal user As String, ByVal pwd As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal user As String, ByVal pwd As String, ByVal Original_ID As Integer, ByVal Original_user As String, ByVal Original_pwd As String) As Integer
            If (user Is Nothing) Then
